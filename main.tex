...
\end{cases}
\]
that forms the boundary in Figure \ref{fig:conexam}. One can compare the relaxed optimal solution, the optimum point $\big( 210,210 \big)$, with the true optimal solution with boundary $\big( 207.1,210 \big)$.
