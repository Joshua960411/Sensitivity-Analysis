...
\KeywordTok{load}\NormalTok{(}\StringTok{"size_effect.Rdata"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{tabular}{cccc}
\toprule
Simulation size & SA margin & SLP margin & RS margin\\
\midrule
12 & 4.5 & 4.4 & 3.9\\
48 & 4.6 & 4.1 & 3.7\\
120 & 4.9 & 4.5 & 5.3\\
