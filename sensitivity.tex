...
In Figure \ref{fig:mean} and Figure \ref{fig:var}, we
apply different values of changes on the twelve  generated scenarios above, and solve a sequence of SLPs to construct the line of changes, so as we can see the valid range of our method graphically. Since these ranges don't change much as simulation size increases, we don't present duplicated figures here. 
