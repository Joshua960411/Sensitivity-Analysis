...
par(bty="l")
plot(epsilon_1,op_set,xlab="Epsilon",ylab="Optimal cost",type="b", bty="l", col=rgb(0.2,0.4,0.1,0.7) , lwd=3 , pch=19)
...
lines(epsilon_2,op_set, col=rgb(0.8,0.4,0.1,0.7) , lwd=3 , pch=19 , type="b" )
legend("topleft", 
...
plot(k_2,op_set,xlab="K",ylab="Optimal cost",type="b", bty="l",col=rgb(0.8,0.4,0.1,0.7), lwd=3 , pch=19)
...
par(bty="l")
lines(k_1,op_set,col=rgb(0.2,0.4,0.1,0.7), lwd=3 , pch=19, type="b" )
...
par(bty="l")
plot(delta,op_set,xlab="Delta",ylab="Optimal cost",type="b", bty="l",col=rgb(0.8,0.4,0.1,0.7) , lwd=2 , pch=19)
...
lines(delta,op_set,col=rgb(0.2,0.4,0.1,0.7), lwd=2 , pch=19, type="b" )
