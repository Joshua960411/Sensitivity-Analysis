...
mac_mean_1<-matrix(c(size,sa_mean_1_12,sa_mean_1_48,sa_mean_1_120,sa_mean_1_240,
                   slp_mean_1_12,slp_mean_1_48,slp_mean_1_120,slp_mean_1_240,
                   rs_mean_1_12,rs_mean_1_48,rs_mean_1_120,rs_mean_1_240),ncol = 4)
df_mean_1<-data.frame(mac_mean_1)
kable(df_mean_1,format='latex', booktabs = T,align = 'c') %>% 
        add_header_above(c("Simulation size", "SA margin","SLP margin","RS margin"),bold = T) %>%
